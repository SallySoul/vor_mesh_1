...
pub fn mesh_2d_to_vtk<P: AsRef<std::path::Path>, TC: InCircleTest<Point = Vec2d>, TT: InTriangleTest, TO: TriangleOrientationTest>(mesh: &DelaunayMesh2d<TC, TT, TO>, triangles: &[usize], p: P) {
